window.__SITE_CONFIG__ = {
  ...
  "apps": [
    ...
    },
    {
      "slug": "wonderplay",
      "name": "奇趣玩",
      "englishName": "WonderPlay",
      "platform": "iOS App",
      "status": "准备提交",
      "iconSrc": "WonderPlay/assets/app-icon.png",
      "iconText": "奇",
      "accent": "#b04f42",
      "accentSoft": "linear-gradient(135deg, #ffe5c4 0%, #e7f4de 55%, #e7f0ff 100%)",
      "tagline": "给孩子的触控、混色和动作小游戏。",
      "summary": "WonderPlay 是一组为儿童和亲子陪伴设计的互动小游戏，包含点点点、颜色魔法和弹射球门。",
      "description": "WonderPlay 让孩子通过点击、摇一摇、倾斜、拍手、拖动和瞄准来探索因果、颜色和力度。当前版本无需账号，不包含广告、内购、第三方分析或云同步。",
      "highlights": [
        "三款可玩小游戏：点点点、颜色魔法、弹射球门。",
        "支持中文和英文，适合 iPhone 和 iPad 横屏使用。",
        "隐私设计简洁：无账号、无广告、无追踪，麦克风仅用于本地识别吹气和拍手。"
      ],
      "links": [
        {
          "label": "营销页",
          "url": "WonderPlay/marketing.html",
          "primary": true
        },
        {
          "label": "支持页",
          "url": "WonderPlay/support.html"
        },
        {
          "label": "隐私页",
          "url": "WonderPlay/privacy-policy.html"
        }
      ],
      "pages": [
        {
      ...
      "images": [
        {
          "src": "WonderPlay/assets/marketing/iphone-hero-zh.png",
          "alt": "WonderPlay 中文 iPhone 横屏营销图",
          "caption": "好奇心小游戏"
        },
        {
          "src": "WonderPlay/assets/marketing/ipad-gallery-zh.png",
          "alt": "WonderPlay 中文 iPad 营销图",
          "caption": "iPad 玩法展示"
        },
        {
          "src": "WonderPlay/assets/marketing/iphone-color-zh.png",
          "alt": "WonderPlay 颜色魔法营销图",
          "caption": "颜色魔法"
        },
        {
          "src": "WonderPlay/assets/marketing/iphone-hero-en.png",
          "alt": "WonderPlay English iPhone landscape marketing image",
          "caption": "English marketing"
        }
      ]
    },
    {
      "appStoreId": 6758551525,
      "slug": "onethought",
      "name": "静念",
      "englishName": "OneThought",
      "platform": "iOS · iPadOS · watchOS",
      "status": "已上架",
      "iconSrc": "OneThought/assets/app-icon.png",
      "iconText": "念",
      "accent": "#d7ad58",
      "accentSoft": "linear-gradient(135deg, #16191c 0%, #2f281b 100%)",
      "tagline": "一念安住，听见内心。",
      "summary": "静念是一款融合木鱼、功德记录、心愿、冥想白噪音、聆听与 Apple Watch 陪伴体验的禅意应用。",
      "description": "通过轻触、摇动或 Apple Watch 敲击木鱼，记录每日功德、来源与勋章进阶；也可以许下心愿，在白噪音、佛曲、有声书和阅读中留出一段安静时间，并管理离线音频缓存。",
      "highlights": [
        "沉浸木鱼：声音、触觉、动画与多种敲击方式。",
        "功德来源、称号勋章、排行榜和心愿，让持续记录有迹可循。",
        "支持 iPhone、iPad 与 Apple Watch，包含冥想白噪音、佛曲、有声书、阅读和离线缓存。"
      ],
      "links": [
        {
          "label": "App Store 中文",
          "url": "https://apps.apple.com/cn/app/id6758551525",
          "primary": true
        },
        {
          "label": "App Store English",
          "url": "https://apps.apple.com/app/id6758551525"
        },
        {
          "label": "营销页",
          "url": "OneThought/marketing.html"
        },
        {
          "label": "支持页",
          "url": "OneThought/support.html"
        },
        {
          "label": "隐私页",
          "url": "OneThought/privacy-policy.html"
        }
      ],
      "pages": [
        {
      ...
      "images": [
        {
          "src": "OneThought/assets/screenshots/01-woodfish.png",
          "alt": "静念木鱼主界面",
          "caption": "一念安住"
        },
        {
          "src": "OneThought/assets/screenshots/02-leaderboard.png",
          "alt": "静念功德排行榜",
          "caption": "见证同行"
        },
        {
          "src": "OneThought/assets/screenshots/03-badges.png",
          "alt": "静念功德称号",
          "caption": "修行有迹"
        },
        {
          "src": "OneThought/assets/screenshots/04-listen.png",
          "alt": "静念在线音频来源",
          "caption": "随喜结缘"
        }
      ]
    ...
    {
      "appStoreId": 1275877336,
      "slug": "lovepiano",
      "name": "最爱钢琴曲",
      "englishName": "LovePiano",
      "platform": "iOS App",
      "status": "已上架",
      "iconSrc": "LovePiano/assets/app-icon.png",
      "iconText": "琴",
      "accent": "#e67c73",
      "accentSoft": "linear-gradient(135deg, #171717 0%, #3a2422 100%)",
      "tagline": "让熟悉的琴声，陪你慢下来。",
      "summary": "最爱钢琴曲是一款简洁的钢琴音乐播放器，提供精选曲目、收藏、最近播放、定时关闭与后台播放。",
      "description": "从通勤、阅读到睡前时光，最爱钢琴曲用简洁的播放体验陪伴每一个安静片刻。你可以搜索和收藏曲目、查看最近播放、切换播放模式与速度，并设置按时间或曲目数量自动停止。",
      "highlights": [
        "精选钢琴音乐，支持搜索、收藏和最近播放。",
        "顺序、循环、单曲与随机播放，并可调整播放速度。",
        "支持后台播放、锁屏控制和定时关闭，可通过一次性内购移除广告。"
      ],
      "links": [
        {
          "label": "App Store",
          "url": "https://apps.apple.com/cn/app/id1275877336",
          "primary": true
        },
        {
          "label": "营销页",
          "url": "LovePiano/marketing.html"
        },
        {
          "label": "支持页",
          "url": "LovePiano/support.html"
        },
        {
          "label": "隐私页",
          "url": "LovePiano/privacy-policy.html"
        }
      ],
      "pages": [
        {
      ...
      "images": [
        {
          "src": "LovePiano/assets/piano-rose.jpg",
          "alt": "钢琴键与玫瑰",
          "caption": "让琴声陪你慢下来"
        },
        {
          "src": "LovePiano/assets/piano-keys.jpg",
          "alt": "钢琴键特写",
          "caption": "精选钢琴音乐"
        }
      ]
